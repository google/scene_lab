...
RAW_ASSETS_PATH = os.path.join(SAMPLE_ROOT, 'src', 'rawassets')
...
FLATBUFFERS_CONVERSION_DATA = [
    builder.FlatbuffersConversionData(
        schema=builder.SCENE_LAB_ROOT.join('schemas', 'scene_lab_config.fbs'),
        extension='bin',
        input_files=[os.path.join(RAW_ASSETS_PATH, 'scene_lab_config.json'),]),
    builder.FlatbuffersConversionData(
